...
public class AddEmployee extends JFrame implements ActionListener{
	...
	public AddEmployee() {
		...
		Image i2 = i1.getImage().getScaledInstance(450, 450, Image.SCALE_DEFAULT);     //helps to scale image
		ImageIcon i3 = new ImageIcon(i2);
		JLabel image = new JLabel(i3);
		image.setBounds(380, 60, 450, 370);   //helps to crop image
		add(image);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(aadhar.equals("") || !aadhar.matches("\\d+")){
